...
const HomeComponent = () => {
  ...
  return (
    ...
    >
      <div
        className="container-sm d-flex flex-row justify-content-evenly flex-wrap-reverse pt-5"
        style={{
          height: "100vh",
        }}
      >
        ...
        <div className="middle-content flex-grow-1 d-flex flex-column ">
          ...
          <div className="serviceBox d-flex justify-content-around align-items-baseline">
            <Link className="btn btn-outline-success">Posts</Link>
            <Link className="btn btn-outline-danger">Gallery</Link>
            <a
            ...
            <Link className="btn btn-outline-light">More...</Link>
          </div>
        </div>
        {/* -------------------------------------------------------------- */}
